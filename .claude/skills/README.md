...
| Skill | 触发条件 | 内容 |
| --- | --- | --- |
| [`arkts-rules/`](arkts-rules/SKILL.md) | 写或改 `.ets`/`.ts` 鸿蒙文件、迁移 TS 代码、`arkts-no-*` 报错 | ArkTS 严格规则、TS 反模式改写、5 条高频踩坑 |
...
| [`harmonyos-review/`](harmonyos-review/SKILL.md) | review 鸿蒙代码、PR 审查、上架前自查 | 10 大类 75 条清单规则（+20 条 AGC 拒因）扫描，产出带优先级 markdown 报告 |
