---
description: 签名与 AGC 上架
applyTo: "**/AppScope/app.json5,**/build-profile.json5"
---
...
| 5. 填基础信息 | 应用名、图标、截图（2026-01-07 起有新素材规范）、隐私政策 URL、权限说明 |
| 5.5 **跑云测自检**（强烈建议） | AGC → 软件包管理 → 启动自检：云端真机自动测兼容性/稳定性/性能/功耗/UX/**隐私**，提前暴露拒因 |
| 6. 提交审核 | 一般 1–3 工作日 |
...
- 调试日志泄漏（hilog 未脱敏字段）
- 隐私合规是 2026 头号拒因族：用户同意隐私政策**前**不得取任何权限/个人信息；隐私标签与实际采集一致；拒权后不得重复索权（完整 20 条见 `07-publishing/checklist-2026-rejection-top20.md`）
